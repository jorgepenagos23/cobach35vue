...
<template>
    ...
    <h1>Vista generada por VUE  src/login.vue </h1>
    <div class="flex flex-col items-center justify-center px-6 pt-8 mx-auto md:h-screen pt:mt-0 dark:bg-gray-900">
        <img src="../imagenes/logo35.png" alt="Logo" height="50%">
    ...
    <div class="w-full max-w-xl p-6 space-y-8 sm:p-8 bg-white rounded-lg shadow dark:bg-gray-800">
        ...
        <form class="mt-8 space-y-6" action="#">
            ...
            <button type="submit" class="w-full px-5 py-3 text-base font-medium text-center text-red bg-primary-900 rounded-lg hover:bg-primary-800 focus:ring-4 focus:ring-primary-300 sm:w-auto dark:bg-primary-600 dark:hover:bg-primary-700 dark:focus:ring-primary-800">Entrar</button>
