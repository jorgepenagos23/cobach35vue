...
<div x-data="setup()" :class="{ 'dark': isDark }">
    <div class="min-h-screen flex flex-col flex-auto flex-shrink-0 antialiased bg-white dark:bg-gray-700 text-black dark:text-white">
      ...
      <div class="fixed w-full flex items-center justify-between h-14 text-white z-10">
        <div class="flex items-center justify-start md:justify-center pl-3 w-14 md:w-64 h-14 bg-blue-900 dark:bg-gray-800 border-none">
          <img class="w-7 h-7 md:w-10 md:h-10 mr-2 rounded-md overflow-hidden" src="https://therminic2018.eu/wp-content/uploads/2018/07/dummy-avatar.jpg" />
          <span class="hidden md:block">ADMIN</span>
        </div>
        <div class="flex justify-between items-center h-14 bg-sky-800 dark:bg-gray-800 header-right">
          ...
          <ul class="flex items-center">
            ...
            <li>
              <a href="#" class="flex items-center mr-4 hover:text-blue-100">
                ...
                <div>
                <button class="font-bold text-base lg:text-lg text-slate-200 leading-4 group-hover:text-indigo-400" @click="logout">Cerrar Sesión</button>
             </div>
                 </a>
            </li>
          </ul>
        ...
        <div class="overflow-y-auto overflow-x-hidden flex flex-col justify-between flex-grow">
            ...
            <li>
              <a href="#" class="relative flex flex-row items-center h-11 focus:outline-none hover:bg-blue-800 dark:hover:bg-gray-600 text-white-600 hover:text-white-800 border-l-4 border-transparent hover:border-blue-500 dark:hover:border-gray-800 pr-6">
                ...
                <span class="hidden md:block px-2 py-0.5 ml-auto text-xs font-medium tracking-wide text-blue-500 bg-white rounded-full">New</span>
              </a>
            </li>
            <li>
              <a href="#" class="relative flex flex-row items-center h-11 focus:outline-none hover:bg-blue-800 dark:hover:bg-gray-600 text-white-600 hover:text-white-800 border-l-4 border-transparent hover:border-blue-500 dark:hover:border-gray-800 pr-6">
      ...
      <div class="h-full ml-14 mt-14 mb-10 md:ml-64">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 p-4 gap-4">
          ...
          <article class="relative w-full h-40 bg-cover bg-center group rounded-lg overflow-hidden shadow-lg hover:shadow-2xl transition duration-300 ease-in-out"
                    style="background-image: url('https://www.escenachiapas.com/wp-content/uploads/2019/06/FOTO-BOLET%C3%8DN-COBACH-2-3.jpg');">
                    <img class="absolute bottom-0 right-1 w-[4rem] h-[4rem] transition duration-300 group-hover:scale-[1.4]" src="https://www.agr.una.py/assets/images/iconos/bd.png" 			alt="" />
                        ...
                        <h3 class="text-center">
                            <a class="text-white text-2xl font-bold text-center" href="#">
                                ...
                                <div class="group relative flex cursor-pointer items-center">
                                    <button @click="subiralumno" class="text-white text-sm font-medium uppercase leading-6">Subir hoja de excel</button>
                                </div>
                            </a>
            ...
            <div class="rounded-t mb-0 px-0 border-0">
              <div class="flex flex-wrap items-center px-4 py-2">
                <div class="relative w-full max-w-full flex-grow flex-1">
                  <h3 class="font-semibold text-base text-gray-900 dark:text-gray-50">Trafico de Usuarios</h3>
                </div>
                ...
                <table class="items-center w-full bg-transparent border-collapse">
                  ...
                  <tbody>
                    <tr class="text-gray-700 dark:text-gray-100">
                      <th class="border-t-0 px-4 align-middle border-l-0 border-r-0 text-xs whitespace-nowrap p-4 text-left">Alumnos</th>
                    ...
                    <tr class="text-gray-700 dark:text-gray-100">
                      <th class="border-t-0 px-4 align-middle border-l-0 border-r-0 text-xs whitespace-nowrap p-4 text-left">Orientadores</th>
                    ...
                    <tr class="text-gray-700 dark:text-gray-100">
                      <th class="border-t-0 px-4 align-middle border-l-0 border-r-0 text-xs whitespace-nowrap p-4 text-left">Direccion </th>
                    ...
                    <tr class="text-gray-700 dark:text-gray-100">
                      <th class="border-t-0 px-4 align-middle border-l-0 border-r-0 text-xs whitespace-nowrap p-4 text-left">Subdireccion</th>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 p-4 gap-4 text-black dark:text-white">
          <div class="md:col-span-2 xl:col-span-3">
            <h3 class="text-lg font-semibold">ESPACIO PARA ALGO</h3>
          </div>
...
export default {
  ...
  methods: {
    ...
    subiralumno() {
      axios.get('/inicio-alumno')
        .then(response => {
          console.error('correcto:', response.status);
    ...
    setDark(val) {
      if (val === "dark") {
        ...
        // Agrega las referencias a los elementos DOM necesarios
        // Ejemplo: this.$refs.moon.classList.add("hidden");
        // ...
      } else {
  ...
  mounted() {
    // Cargar Alpine.js después de que Vue.js haya inicializado el componente
    const script = document.createElement('script');
    script.src = 'https://cdnjs.cloudflare.com/ajax/libs/alpinejs/2.8.1/alpine.js';
    script.defer = true;
